"""
Pytest configuration and fixtures for MYTUBE-431 tests.

This module provides centralized fixture configuration for all tests in the
MYTUBE-431 test suite, enabling environment-based configuration for CI and
...
def browser():
    ...
    - PLAYWRIGHT_SLOW_MO (default: "0"): Slow down Playwright operations (ms)
