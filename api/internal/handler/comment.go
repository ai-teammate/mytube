...
func NewVideoCommentsHandler(comments CommentStore, users CommentUserProvider) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		switch r.Method {
		case http.MethodGet:
			getCommentsHandler(comments, videoID, w, r)
		case http.MethodPost:
			postCommentHandler(comments, users, videoID, w, r)
		default:
...
func NewDeleteCommentHandler(comments CommentStore, users CommentUserProvider) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if commentID == "" || !isValidVideoID(commentID) {
...
func getCommentsHandler(comments CommentStore, videoID string, w http.ResponseWriter, r *http.Request) {
...
func postCommentHandler(comments CommentStore, users CommentUserProvider, videoID string, w http.ResponseWriter, r *http.Request) {
	claims := middleware.ClaimsFromContext(r.Context())
	if claims == nil {
		writeJSONError(w, "unauthorized", http.StatusUnauthorized)
		return
